...
function updateView(obj, state)
    ...
    if state.running_flag == 1
        TactI_h = getTransMatrix(state.TI_0,state.kin.a_j,state.kin.alpha_j,state.kin.d_j,state.kin.theta_O_j,state.kin.j_type,state.act.q_pos);
        TdesI_h = getTransMatrix(state.TI_0,state.kin.a_j,state.kin.alpha_j,state.kin.d_j,state.kin.theta_O_j,state.kin.j_type,state.des.q_pos);
    else
