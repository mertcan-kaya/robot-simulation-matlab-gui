function loadModelStruct(app)
    ...
    if app.line_on == 0
        ...
        elseif app.robot_model == 2
            ...
            if app.high_quality == 1
                ...
                if app.ee_att == 1
                    ...
                    temp = load('meshes\fer\collision\finger.mat');   app.ms.sFl = temp.modelstruct;
                    temp = load('meshes\fer\collision\finger.mat');   app.ms.sFr = temp.modelstruct;
                end
            end
        end
        ...
        if app.coord_frame_on == 1 && (app.task_mode == 1 && app.running_flag == 0) || (app.task_mode == 2 && (app.running_flag == 0 || app.trj_profile == 0))
