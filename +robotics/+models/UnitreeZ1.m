classdef UnitreeZ1 < robotics.models.RobotModel
    properties
        Name = 'Unitree Z1'
    end
    ...
    methods
        ...
        function dyn = getInertialParameters(obj)
            ...
            Ij_cj = zeros(3,3,6);
            Ij_cj(:,:,1) = robotics.math.symmetrize(0.00128328,-6e-08,-4e-07 ...
                                      ,0.00071931,5e-07 ...
                                       ,0.00083936);
            Ij_cj(:,:,2) = robotics.math.symmetrize(0.00102138,0.00062358,5.13e-06 ...
                                      ,0.02429457,-2.1e-06 ...
                                       ,0.02466114);
            Ij_cj(:,:,3) = robotics.math.symmetrize(0.00108061,-8.669e-05,-0.00208102 ...
                                      ,0.00954238,-1.332e-05 ...
                                       ,0.00886621);
            Ij_cj(:,:,4) = robotics.math.symmetrize(0.00031576,8.13e-05,4.091e-05 ...
                                      ,0.00092996,-5.96e-06 ...
                                       ,0.00097912);
            Ij_cj(:,:,5) = robotics.math.symmetrize(0.00017605,4e-07,5.689e-05 ...
                                      ,0.00055896,-1.3e-07 ...
                                       ,0.0005386);
            Ij_cj(:,:,6) = robotics.math.symmetrize(0.00018328,1.22e-06,5.4e-07 ...
                                      ,0.0001475,8e-08 ...
                                       ,0.0001468);
